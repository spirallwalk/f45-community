...
// ── 공지사항 데이터 (여기서 수정하세요) ──────────────────────────────
const NOTICES = [
  { id: 1, text: '이번주 출석왕은 철인왕자님! 🔥 이번 주도 화이팅!', accent: 'red' },
  { id: 2, text: '📅 7월 3일(목) 오전 6시 수업은 특별 HIIT 세션으로 진행됩니다.', accent: 'blue' },
  { id: 3, text: '🏅 45회 달성 멤버 모집 중 — 커뮤니티에서 인증해보세요!', accent: 'red' },
] as const
// ────────────────────────────────────────────────────────────────────
